...
export default function LoginPage() {
  ...
  // Detect PASSWORD_RECOVERY flow (set by auth.tsx onAuthStateChange)
  useEffect(() => {
    if (localStorage.getItem('tbh-next-pw-recovery') === '1') {
      setIsRecovery(true);
      localStorage.removeItem('tbh-next-pw-recovery');
    }
  }, []);
