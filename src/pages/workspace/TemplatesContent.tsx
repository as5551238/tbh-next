        ...
        <div className="flex-1 min-w-0 rounded-xl border border-border bg-surface p-4">
          {selected ? (
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => handleUse(selected.id)} className="flex items-center gap-1 rounded-lg bg-primary/10 px-3 py-1.5 text-[11px] font-semibold text-primary-2 hover:bg-primary/20 transition-all">
                  <Copy size={12} />
                  使用模板
                </button>
